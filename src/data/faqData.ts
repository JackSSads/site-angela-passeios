export const faqData = [
  { q: "Posso levar comida para o passeio?", a: "Sim! Você pode levar lanches e bebidas. Também temos bar a bordo com opções variadas." },
  { q: "O passeio pode ser cancelado por causa do clima?", a: "Sim. A segurança é prioridade. Em caso de mau tempo, o passeio é reagendado ou reembolsado." },
