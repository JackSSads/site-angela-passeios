...
const details = [
  ...
  { icon: Users, title: "Tripulação", desc: "Equipe qualificada e certificada pela Marinha do Brasil" },
  ...
  { icon: Wrench, title: "Equipamentos", desc: "Máscara, snorkel e colete salva-vidas inclusos" },
];
